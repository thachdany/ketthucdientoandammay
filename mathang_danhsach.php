      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <?php 
            ...
            $result = mysqli_query($conn, 'select count(MaHang) as total from mathang');
            $total_records=0;
            if($result==TRUE){              
            ...
            $sql="SELECT mh.MaHang, mh.TenHang, mh.GiaBan, mh.Mota, mh.LinkAnh, dm.Tendanhmuc FROM mathang mh, danhmuc dm WHERE mh.Madanhmuc=dm.Madanhmuc LIMIT $start, $limit";
                ...
                <?php
                  ...
                  if($result==true && $result->num_rows>0){
                    ...
                    while($row = $result->fetch_assoc()) {
                      ...
                      <tr>
                      <?php
                      echo "<td style='text-align: center;'>".$i."</td>"."<td>".$row["TenHang"]."</td>"."<td>".$row["Tendanhmuc"]."</td>"."<td>".$row["GiaBan"]."</td>";
                      ?>
                      <td>
                        <a href="mathang_capnhat.php?id=<?php echo $row['MaHang']; ?>" class="table_items">Sửa</a>
                        <a href="xuly_mathang.php?tacvu=xoa&id=<?php echo $row['MaHang']; ?>" class="table_items" style="margin-left: 10px;">Xóa</a>
                      </td>
                      </tr>
                      <?php
                      $i=$i+1;
