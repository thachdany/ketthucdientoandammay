  ...
  <div style="margin-left: 20px; margin-right: 20px;">
    ...
    <div class="btn-group" style="margin-top: 10px;">
      ...
      <button type="button" class="btn btn-outline-primary"
        onclick="location.reload();">Vận chuyển-Huyện, TP</button>
    </div>
    <!--Bảng-->
      ...
      <div class="col-9">
        <div class="card">
          <div class="card-header" style="background-color: green; border: #F5CFCF; color: white;">       
            <h4 style="font-weight: bold;">Danh sách Huyện, Thành phố</h4>
          </div>
          <div class="card-body row">
            <div class="col-2"></div>
            <div class="col-8">
              <button class="btn  btn-primary" style="margin-top: 10px; margin-bottom: 10px;"
                onclick="window.open('vanchuyenhuyen_them.php','_self')">Thêm mới</button>
              <table class="table">
                <!--Tiêu đề-->
                  ...
                  <?php
                    ...
                    if($result->num_rows>0){
                      ...
                      while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                        <?php
                        echo "<td style='text-align: center;'>".$i."</td><td>".$row["Tenhuyen"]."</td><td>".$row["PhiVanchuyen"]."</td>"
                        ?>
                        <td>
                          <a href="vanchuyenhuyen_capnhat.php?id=<?php echo $row['Mahuyen']; ?>" class="table_items">Sửa</a>
                          <a href="xuly_vanchuyenhuyen.php?tacvu=xoa&id=<?php echo $row['Mahuyen']; ?>" class="table_items" style="margin-left: 10px;">Xóa</a>
                        </td>
                        </tr>
                        <?php
                        //Tăng số thứ tự
